...
export default function App() {
 ...
 <Routes>
 <Route exact path="/" element={ <News key="general" catagory={"general"}/>}/>
 ...
 <Route exact path="/worldt" element={ <News2 key="worldt" q={"world"}/>}/>
 <Route exact path="/pakistan" element={ <News key="pakistan" catagory={"pakistan"}/>}/>
 <Route exact path="/politicst" element={ <News2 key="politicstt" q={"politics"}/>}/>
 <Route exact path="/wart" element={ <News2 key="wartt" q={"war"}/>}/>
